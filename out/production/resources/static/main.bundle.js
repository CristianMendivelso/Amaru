...
var User = (function () {
    function User(name, lastname, image, phone, password, email, description, type, username, rate) {
        this.name = name;
...
var UsersService = (function (_super) {
    ...
    ;
    UsersService.prototype.create = function (name, lastname, image, phone, password, email, description, type, username, rate) {
        return this.post(this.resourceUrl, new __WEBPACK_IMPORTED_MODULE_5__models_user__["a" /* User */](name, lastname, image, phone, password, email, description, type, username, rate));
    };
    return UsersService;
