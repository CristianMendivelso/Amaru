...
var UserProfilePageComponent = (function () {
    ...
    UserProfilePageComponent.prototype.onSubmitRate = function () {
        var _this = this;
        this.usersService.editRate(this.username, this.userForm.get('sel1').value).subscribe(function (serverResponse9) {
            _this.router.navigate(['']);
        }, function (error) {
            console.log(error);
        });
