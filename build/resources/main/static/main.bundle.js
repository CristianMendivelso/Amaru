...
var Group = (function () {
    function Group(name, instructor, place, days, hour, description, category) {
        this.name = name;
...
var GroupEditPageComponent = (function () {
    ...
    GroupEditPageComponent.prototype.onSubmit = function () {
        ...
        this.groupService.create(this.groupForm.get('name').value, this.user, this.groupForm.get('place').value, this.days, this.groupForm.get('hour').value, this.groupForm.get('description').value, this.groupForm.get('category').value).subscribe(function (serverResponse) {
...
var GroupProfilePageComponent = (function () {
    ...
    GroupProfilePageComponent.prototype.ngOnInit = function () {
        ...
        this.groupService.getGroupByName(this.groupname).subscribe(function (groupResponse) {
...
var GroupService = (function (_super) {
    ...
    GroupService.prototype.create = function (name, instructor, place, days, hour, description, category) {
        return this.post(this.resourceUrl + "groups", new __WEBPACK_IMPORTED_MODULE_1__models_group__["a" /* Group */](name, instructor, place, days, hour, description, category));
    };
